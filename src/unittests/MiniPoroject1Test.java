...
public class MiniPoroject1Test {
	...
	Material snowM = new Material().setKd(0.3).setKs(0.6).setShininess(200).setKr(0.4);
		...
		scene.geometries.add(new Triangle(new Point(10000,0,0), new Point(-10000, 0, 0), //
				new Point(0, -10000, 0)).setEmission(new Color(0,50,100)).setMaterial(seaM));
		...
		scene.geometries.add(new Triangle(new Point(-83,-220,37), new Point(-83,-198,43), //
				new Point(-76,-209,43)).setEmission(new Color(0,0,0)).setMaterial(birdM));
		//bird 1
		scene.geometries.add(new Triangle(new Point(66,199,78), new Point(66,184,92), //
				new Point(61,184,86)).setEmission(new Color(0,0,0)).setMaterial(birdM));
		scene.geometries.add(new Triangle(new Point(66,199,78), new Point(83,198,86), //
				new Point(76,209,86)).setEmission(new Color(0,0,0)).setMaterial(birdM));
		scene.geometries.add(new Triangle(new Point(40,173,78), new Point(66,184,92), //
					new Point(61,184,86)).setEmission(new Color(0,0,0)).setMaterial(birdM));
		scene.geometries.add(new Triangle(new Point(83,220,74), new Point(83,198,86), //
				new Point(76,209,86)).setEmission(new Color(0,0,0)).setMaterial(birdM));

		ImageWriter imageWriter = new ImageWriter("mountain", 500, 500);
